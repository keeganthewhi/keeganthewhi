...
![AI Safety](https://img.shields.io/badge/AI_Safety-222222?style=flat-square&logoColor=white)
...
![SSE](https://img.shields.io/badge/SSE-333333?style=flat-square&logoColor=white)
...
#### [`tenth-man-mcp`](https://github.com/keeganthewhi/tenth-man-mcp)
> **Adversarial AI Review System**
>
> 3 contrarian agents challenge every critical change before execution. Multi-model orchestration with Claude, Codex, and Gemini implementing generator-critic role separation.
>
> `TypeScript` `MCP` `Multi-Agent` `AI Safety`

</td>
<td width="50%">

#### AI Governance Framework
> **Production LLM Steering System**
>
> 27,000-line technical atlas with 88 behavioral governance tokens. Validated over 500+ autonomous sessions across 3-5 day development cycles without human intervention.
>
> `Claude API` `Constitutional AI` `Prompt Engineering`
...
#### E-Commerce Platform
> **B2B/B2C Production System**
>
> 88 Prisma models, 50 NestJS modules, 63 API controllers. BOLA protection, 5-layer pricing engine, BullMQ workers, Docker orchestration (8 containers).
>
> `NestJS` `Prisma` `PostgreSQL` `Docker` `Redis`
...
#### Jarvis - Windows Vision Agent
> **Realtime Desktop Automation**
>
> Vision-based pointer calibration, closed-loop self-healing, autonomous app-learning via deterministic skill maps, natural language control through persistent WebSocket sessions.
>
> `Electron` `OpenAI Realtime API` `TypeScript`
...
>
> Academic contribution on EEG-based mental health classification using Tangent-Secant Similarity Index framework. Neural network architectures for biomedical signal processing.
>
